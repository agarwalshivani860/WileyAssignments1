...
public class ShareHolderServiceImpl implements ShareHolderService {
	...
	@Override
	public void viewdetails(int holderid) {
	...
	@Override
	public void buyStock(int sid,double quantity) throws ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
	...
	@Override
	public void updateStock(int stockidPurchased,double quantityBought) {
		// TODO Auto-generated method stub
		//this methods updates stock in stockholder database that is go to dao layer
		ShareHolderDaoImpl shd=new ShareHolderDaoImpl();
		shd.updateShareHolderStocks(stockidPurchased,quantityBought);
