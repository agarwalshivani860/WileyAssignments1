...
public class CompanyServiceImpl implements CompanyService {
	...
	@Override
	public void autoUpdateStocks(int sid,int qty) throws ClassNotFoundException, SQLException {
	...
	@Override
	public ArrayList<Integer> toGetPriceQuantity(int stockid) throws ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
		CompanyDaoImpl cdao=new CompanyDaoImpl();
	...
	@Override
	public void generateStocks() throws ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
		CompanyDaoImpl cdao=new CompanyDaoImpl();
		cdao.shareStocks();
